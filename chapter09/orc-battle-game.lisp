(in-package :cl-user)
(defpackage land-of-lisp.chap9
  (:use :cl))
(in-package :land-of-lisp.chap9)
...
(defun show-player ()
  (fresh-line)
  (princ "You are a valiant knight withe a health of ")
  (princ *player-health*)
  (princ ", an agility of ")
  (princ *player-agility*)
  (princ ", and a strengh of ")
  (princ *player-strength*))

(defun player-attack ()
  (fresh-line)
  (princ "Attack style: [s]tab [d]ouble swig [r]oundhouse:")
  (case (read)
    (s (monster-hit (pick-monster) (+ 2 (randval (ash *player-strength* -1)))))
    (d (let ((x (randval (truncate (/ *player-strength* 6)))))
         (princ "Your double swig has a strength of ")
         (princ x)
         (fresh-line)
