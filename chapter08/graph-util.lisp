(in-package :cl-user)
(defpackage land-of-lisp.chap8.graph-util
  (:use :cl)
  (:export :ugraph->png))
(in-package :land-of-lisp.chap8.graph-util)
...
;;; Generating the DOT inforamtion

;; Convering node identifiers
(defun dot-name (exp)
...
;; Convering edges into DOT format
...
(defun dot->png (fname thunk)
  ...
  #+ccl
  (ccl:run-program "bash" '("-c" "dot -Tpng")
                   :input fname
